...
namespace BassWebV3.Controllers
{
    ...
    public class ReportsController : AbstractBassController
    {
        ...
        public FileResult ExportBWExcel([DataSourceRequest]DataSourceRequest request, string data)
        {
            ...
            row.CreateCell(1, CellType.String).SetCellValue("Facility");
            row.CreateCell(2, CellType.String).SetCellValue("ClientName");
            row.CreateCell(3, CellType.String).SetCellValue("CDCRNum");
            row.CreateCell(4, CellType.String).SetCellValue("Face to Face Amount");
            row.CreateCell(5, CellType.String).SetCellValue("Medi-cal Amount");
            row.CreateCell(6, CellType.String).SetCellValue("Medi-cal Admin Reinstatement");
            row.CreateCell(7, CellType.String).SetCellValue("SSI Amount");
            row.CreateCell(8, CellType.String).SetCellValue("VA Amount");
            row.CreateCell(9, CellType.String).SetCellValue("SNP/REFUSE Amount");
            row.CreateCell(10, CellType.String).SetCellValue("CID Needs Assessment");
            ...
            for (int line = 0; line < count; line++)
            {
                ...
                headerrow.CreateCell(3, CellType.String).SetCellValue(ptvr.Count());
                headerrow.CreateCell(4, CellType.String).SetCellValue(ptvr.Sum(s => s.FaceToFace));
                headerrow.CreateCell(5, CellType.String).SetCellValue(ptvr.Sum(s => s.MCTotal));
                headerrow.CreateCell(6, CellType.String).SetCellValue(ptvr.Sum(s => s.TMediCalAReinstatement));
                headerrow.CreateCell(7, CellType.String).SetCellValue(ptvr.Sum(s => s.SSITotal));
                headerrow.CreateCell(8, CellType.String).SetCellValue(ptvr.Sum(s => s.VATotal));
                headerrow.CreateCell(9, CellType.String).SetCellValue(ptvr.Sum(s => s.SNPRTotal));
                headerrow.CreateCell(10, CellType.String).SetCellValue(ptvr.Sum(s => s.CIDNeedsAssessment));
                ...
                foreach (var item in ptvr)
                {
                    ...
                    row1.CreateCell(1, CellType.String).SetCellValue(item.Facility);
                    row1.CreateCell(2, CellType.String).SetCellValue(item.ClientName);
                    row1.CreateCell(3, CellType.String).SetCellValue(item.CDCRNum);
                    row1.CreateCell(4, CellType.String).SetCellValue(item.FaceToFace);
                    row1.CreateCell(5, CellType.String).SetCellValue(item.MCTotal);
                    row1.CreateCell(6, CellType.String).SetCellValue(item.TMediCalAReinstatement);
                    row1.CreateCell(7, CellType.String).SetCellValue(item.SSITotal);
                    row1.CreateCell(8, CellType.String).SetCellValue(item.VATotal);
                    row1.CreateCell(9, CellType.String).SetCellValue(item.SNPRTotal);
                    row1.CreateCell(10, CellType.String).SetCellValue(item.CIDNeedsAssessment);
                ...
                footerrow.CreateCell(1, CellType.String).SetCellValue("");
                footerrow.CreateCell(2, CellType.String).SetCellValue("Group Total:");
                footerrow.CreateCell(3, CellType.String).SetCellValue(ptvr.Count());
                footerrow.CreateCell(4, CellType.String).SetCellValue(ptvr.Sum(s => s.FaceToFace));
                footerrow.CreateCell(5, CellType.String).SetCellValue(ptvr.Sum(s => s.MCTotal));
                footerrow.CreateCell(6, CellType.String).SetCellValue(ptvr.Sum(s => s.TMediCalAReinstatement));
                footerrow.CreateCell(7, CellType.String).SetCellValue(ptvr.Sum(s => s.SSITotal));
                footerrow.CreateCell(8, CellType.String).SetCellValue(ptvr.Sum(s => s.VATotal));
                footerrow.CreateCell(9, CellType.String).SetCellValue(ptvr.Sum(s => s.SNPRTotal));
                footerrow.CreateCell(10, CellType.String).SetCellValue(ptvr.Sum(s => s.CIDNeedsAssessment));
            ...
            row2.CreateCell(2, CellType.String).SetCellValue("");
            row2.CreateCell(3, CellType.String).SetCellValue(productivities.Count());
            row2.CreateCell(4, CellType.String).SetCellValue(productivities.Sum(s => s.FaceToFace));
            row2.CreateCell(5, CellType.String).SetCellValue(productivities.Sum(s => s.MCTotal));
            row2.CreateCell(6, CellType.String).SetCellValue(productivities.Sum(s => s.TMediCalAReinstatement));
            row2.CreateCell(7, CellType.String).SetCellValue(productivities.Sum(s => s.SSITotal));
            row2.CreateCell(8, CellType.String).SetCellValue(productivities.Sum(s => s.VATotal));
            row2.CreateCell(9, CellType.String).SetCellValue(productivities.Sum(s => s.SNPRTotal));
            row2.CreateCell(10, CellType.String).SetCellValue(productivities.Sum(s => s.CIDNeedsAssessment));
